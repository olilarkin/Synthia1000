...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Synthia1000 Demo Installer\n"
      else:
        line="OutputBaseFilename=Synthia1000 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Synthia1000 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Synthia1000 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Synthia1000 Demo installer\n"
     else:
       line="SetupWindowTitle=Synthia1000 installer\n"
