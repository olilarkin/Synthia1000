/* Declares the Synthia1000 Audio Worklet Node */

class Synthia1000Controller extends WAMController
{
  constructor (actx, options) {
    ...
    super(actx, "Synthia1000", options);
  }
  ...
  static importScripts (actx) {
    ...
    return new Promise( (resolve) => {
      ...
      actx.audioWorklet.addModule(origin + "scripts/Synthia1000-awp.js").then(() => {
        resolve();
      }) }) });
    })
  }
